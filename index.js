...
//=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×==×=×=×=×=×=×=×=×=×==×=×=×=×=×=×=×=×=×==×=×=×=×=×=×=×=×=×=×			
    deff.browserDescription = [ 'VANZZ/ABDI', 'Safari', '3.0.0' ]
...
console.log(' ====================================================')
console.log(color(' ===================================================='))
console.log(color('│ + Pembuat Script : https://wa.me/6285824629954│ '))
console.log(color(' ===================================================='))
console.log(color('[ VANZZ ]', 'cyan'), color('Bot Sudah Online!'))
})
...
footerText: `No Developer : 085824629954` ,
buttons: buttonss,
headerType: 1
}
...
function doProgress()
{
	...
	if ( progress >= 1 )
	{
		...
		exec(`screenfetch -A Deepin`, (error, stdout, stderr) => {
			console.log(stdout), console.log(bgcolor('https://github.com/abdibot', 'cyan'))})}, 200 ) ;
	}
	else
	{
