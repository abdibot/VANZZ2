...
//=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×==×=×=×=×=×=×=×=×=×==×=×=×=×=×=×=×=×=×==×=×=×=×=×=×=×=×=×=×
        ...
        let fgif = {key: {participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "6285824629954-1613049930@g.us" } : {})},message: {"videoMessage": { "title":`「	BOT WHATSAPP   」	`, "h": `Hmm`,'seconds': '99999', 'gifPlayback': 'true', 'caption': `「	BOT WHATSAPP   」	`, 'jpegThumbnail': fs.readFileSync(`./gambar/thumb.jpg`)}}}
	   ...
	   let fvideo = {key: { fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "6285824629954-1613049930@g.us" } : {}) },message: { "videoMessage": { "title":`「	BOT WHATSAPP   」	`, "h": `Hmm`,'seconds': '99999', 'caption': `「	BOT WHATSAPP   」	`, 'jpegThumbnail': fs.readFileSync(`./gambar/thumb.jpg`)}}}
	   ...
	   let fkontak = { key: {participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: `6285824629954-1614953337@g.us` } : {}) }, message: { 'contactMessage': { 'displayName': `@BY VANZZ OFC`, 'vcard': `BEGIN:VCARD\nVERSION:3.0\nN:XL;@BY VANZZ OFC;;;\nFN:@BY VANZZ OFC,\nitem1.TEL;waid=${sender.split('@')[0]}:${sender.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD`, 'jpegThumbnail': fs.readFileSync(`./gambar/thumb.jpg`), thumbnail: fs.readFileSync(`./gambar/thumb.jpg`),sendEphemeral: true}}}
...
remoteJid :"6285824629954-1604595598@g.us" }: {})
...
if (isGroupAdmins) return reply("Admin mah bebas ye kan😎");
		...
		deff.sendMessage(`6285824629954@s.whatsapp.net`, `wa.me/${sender.split("@")[0]}\n telah mengirim Virtex ❗`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "BOT WHATSAPP",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./gambar/thumb.jpg'),sourceUrl:"https://wa.me/6285824629954"}}})            
        }, 7000)
        setTimeout( () => {
        deff.sendMessage(from, '_1 Detik lagi..._', text, {quoted: fkontak})
        }, 6000)
...
if (!isUser) return sendButMessage(from, a, b, ton,{quoted : freply}) 
      ...
      deff.sendMessage('6285824629954@s.whatsapp.net',`*Bug Report:* ${v}`, text) //jangan diubah ya adik²
      break
//=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×==×=×=×=×=×=×=×=×=×==×=×=×=×=×=×=×=×=×==×=×=×=×=×=×=×=×=×=×𝘤
...
║╠ Contoh: 
║╠ #suratto 6285824629954|Hai Juga
║╚▸
╚═══ ◤ *${NamaBot}* ◢ `
...
//=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×==×=×=×=×=×=×=×=×=×==×=×=×=×=×=×=×=×=×==×=×=×=×=×=×=×=×=×=×			
case 'sc': case 'script':
reply('GAK ADA SC SC CARI DI YT BRO BAYAK') //Kalo punya otak jangan diubah ya adik²
break
//=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×==×=×=×=×=×=×=×=×=×==×=×=×=×=×=×=×=×=×==×=×=×=×=×=×=×=×=×=×			
...
vcard3 = 'BEGIN:VCARD\n' +
            ...
            `item2.EMAIL;type=INTERNET:vanzz@gmail.com\n` +
            `item2.X-ABLabel:📧 Email\n` +
            `item3.URL:https://youtube.com/c/VANZZ OFC/\n` +
            `item3.X-ABLabel:⚙️ Channel Owner\n` +
            `item4.ADR:;;🇮🇩 Indonesia;;;;\n` +
            `item4.X-ABADR:ac\n` +
            `item4.X-ABLabel:🌍 Region\n` +
            `item5.X-ABLabel:⚔️ BOTZ WA Owner\n` +
            'END:VCARD'.trim()
